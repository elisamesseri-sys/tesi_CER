...
# 5 prosumer con lo stesso profilo fotovoltaico

pv_tot = [5 * valore for valore in pv_singolo]
...
print("Numero utenti:", len(utenti))
print("Numero prosumer:", len(prosumer))
print("Numero consumer:", len(utenti) - len(prosumer))
...
# Variabile binaria:
# 1 = acquisto dalla rete consentito
# 0 = immissione in rete consentita
